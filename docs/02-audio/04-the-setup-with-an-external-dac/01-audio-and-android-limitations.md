...
| External DAC support |  Full, all formats incl. DSD/MQA |  Yes, even DSD/MQA (but not bit-perfect) |  Limited |
| Exclusive mode |  Yes |  No |  No |
| DSD native / DoP |  Native and DoP supported |  Native (via USB DAC), but mixed |  Limited |
| MQA |  Full decode + render |  Only for MQA 96kHz, partial |  Not officially supported |
