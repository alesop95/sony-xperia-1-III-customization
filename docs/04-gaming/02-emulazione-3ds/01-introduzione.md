...
1.  Altissima compatibilità
1.  Interfaccia pulita, tantissime opzioni
1.  Salvataggi automatici, upscaling 2x/3x
1.  Supporta shader, layout schermo doppio/piccolo
...
1.  Nessun menu per modding avanzato
1.  Stabile e regolarmente aggiornato, compatibile con Android 9-15

Mentre invece Citra MMJ (moddata):

1.  Texture packs (HD & custom)
1.  Shader personalizzati
1.  Cheat codes  (supporta file .txt o da UI)
1.  Upscaling avanzato fino a 10x
1.  Config per ogni gioco
1.  Interfaccia avanzata (temi, filtri, animazioni, salvataggi personalizzati)
1.  Non aggiornata ufficialmente → sviluppo community
1.  Alcune build sono più "grezze", ma ideali per chi smanetta
